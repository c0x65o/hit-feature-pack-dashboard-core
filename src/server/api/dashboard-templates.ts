...
// - schema/dashboards/templates/*.(json|yaml|yml)
// - schema/dashboards/*.(json|yaml|yml)
// - dashboards/templates/*.(json|yaml|yml)
// - dashboards/*.(json|yaml|yml)
//
...
function loadRegistry(projectRoot: string): any | null {
  try {
...
export async function GET(request: NextRequest) {
  ...
  const filtered = pack ? templates.filter((t: any) => String(t?.packName || '').trim() === pack) : templates;
